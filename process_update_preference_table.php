...
if(isset($_POST))
{
	...
	{
		$stmt = $pdo->prepare ("UPDATE lucky8_admin_preference SET store_datetime_start= :store_datetime_start , store_datetime_end= :store_datetime_end, store_date_startend_always_current=:store_date_startend_always_current , playable_duration = :playable_duration , playable_times = :playable_times, max_win_times_per_duration = :max_win_times_per_duration WHERE 	id_preference=:id_preference");
